...
export class Information {
	...
	remove(id) {
		return $.post(PathUtil.resolve('admin/information/remove'), { id })
	}
	...
	create(postData) {
		return $.post(PathUtil.resolve('admin/information/create'), postData).then(data => data.result)
	}
	update(postData) {
		return $.post(PathUtil.resolve('admin/information/update'), postData).then(data => data.result)
	}
	private _loadData() {
		return $.post(PathUtil.resolve('admin/information/getList')).then(data => data.result)
	}
	loadData() {

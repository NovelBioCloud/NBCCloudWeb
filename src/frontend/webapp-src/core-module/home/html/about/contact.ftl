<div class='nb-page-about-contact'>
    <div class='nb-page-about-contact-lines'>
        <div class='nb-page-about-contact-line'>
            <span class='contact-line-telephone'></span>
        </div>
        <div class='nb-page-about-contact-line'>
            <span class='contact-line-email'></span>
        </div>
        <div class='nb-page-about-contact-line'>
            <span class='contact-line-fax'></span>
        </div>
    </div>
    <div class='nb-page-about-contact-contents'>

...
export class Video {
	...
	remove(id) {
		return $.post(PathUtil.resolve('admin/video/remove'), { id })
	}
	...
	create(postData) {
		return $.post(PathUtil.resolve('admin/video/create'), postData).then(data => data.result)
	}
	update(postData) {
		return $.post(PathUtil.resolve('admin/video/update'), postData).then(data => data.result)
	}
	private _loadData() {
		return $.post(PathUtil.resolve('admin/video/getList')).then(data => data.result)
	}
	loadData() {

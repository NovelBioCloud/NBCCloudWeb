...
export class Recruitment {
	...
	remove(id) {
		return $.post(PathUtil.resolve('admin/recruitment/remove'), { id })
	}
	...
	create(postData) {
		return $.post(PathUtil.resolve('admin/recruitment/create'), postData).then(data => data.result)
	}
	update(postData) {
		return $.post(PathUtil.resolve('admin/recruitment/update'), postData).then(data => data.result)
	}
	private _loadData() {
		return $.post(PathUtil.resolve('admin/recruitment/getList')).then(data => data.result)
	}
	loadData() {

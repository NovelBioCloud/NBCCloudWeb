...
<head>
	...
	<link rel="stylesheet" type="text/css" href="${contextPath}/base-lib/lib/font-awesome/css/font-awesome.min.css" />
  	<link rel="stylesheet" type="text/css" href="${contextPath}/biz-module/home/css/admin.css" />
	<script language="JavaScript">
		var contextPath = '${contextPath}'
	</script>
	<script type="text/javascript" src="${contextPath}/base-lib/lib/jquery/jquery-2.1.1.min.js" ></script>
	...
	<script type="text/javascript" src="${contextPath}/biz-module/home/js/admin.js" ></script>
</head>
<body>
